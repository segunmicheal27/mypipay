...
class KYC_1 extends StatelessWidget {
  KYC_1({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 158.0, middle: 0.3491),
                  Pin(size: 22.0, middle: 0.7302),
                  child: Text(
                    '+90 658 656 8585',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 129.0, middle: 0.3485),
                  Pin(size: 57.0, end: 6.0),
                  child: Text(
                    '_ _ _ _',
                    style: TextStyle(
                      fontFamily: 'Montserrat',
          ...
          Pinned.fromPins(
            Pin(start: 32.0, end: 40.5),
            Pin(size: 15.0, middle: 0.3237),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
